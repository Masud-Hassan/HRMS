        ...
        <div class="account-content">
            ...
            <div class="container">
                ...
                <div class="account-logo">
                    <a href="index.html"><img src="{{ URL::to('assets/img/logo.png') }}" alt="SoengSouy"></a>
                </div>
                <!-- /Account Logo -->
                    ...
                    <div class="account-wrapper">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="select @error('position') is-invalid @enderror" name="position" id="position">
                                    <option selected disabled>-- Select Position --</option>
                                    @foreach ($position as $name)
                                        <option value="{{ $name->position }}">{{ $name->position }}</option>
                                    @endforeach
                                </select>
                                @error('position_name')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="account-footer">
                                <p>Back to <a href="{{ route('home') }}">Dashboard</a>?</p>
                            </div>
                        </form>
                        <!-- /Account Form -->
                    </div>
